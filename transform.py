...
# Transform from source view to target view (generic)
def transform_from_to(src_view, target_view):
    transform = np.dot(get_transform_from_global(target_view),
                       get_transform_to_global(src_view))

    return transform


# Transform from source lidar view to target lidar view
